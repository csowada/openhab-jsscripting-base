 ...
 */
export declare const get: (key: string, defaultSupplier?: any) => any;
/**
 ...
 */
export declare const put: (key: string, value: any) => any | null;
/**
 ...
 */
export declare const remove: (key: string) => any | null;
