...
interface CollectorsStatic {
  ...
  collectingAndThen<RR, R>(arg0: any /*java.util.stream.Collector*/, arg1: java.util.funktion.Func<R, RR>): any /*java.util.stream.Collector*/;
  counting(): any /*java.util.stream.Collector*/;
  filtering<T>(arg0: java.util.funktion.Predicate<T>, arg1: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  flatMapping<T, U>(arg0: java.util.funktion.Func<T, java.util.stream.Stream<U>>, arg1: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  groupingBy<K, T, M>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Supplier<M>, arg2: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  groupingBy<K, T>(arg0: java.util.funktion.Func<T, K>, arg1: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  groupingBy<K, T>(arg0: java.util.funktion.Func<T, K>): any /*java.util.stream.Collector*/;
  groupingByConcurrent<K, T>(arg0: java.util.funktion.Func<T, K>): any /*java.util.stream.Collector*/;
  groupingByConcurrent<K, T, M>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Supplier<M>, arg2: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  groupingByConcurrent<K, T>(arg0: java.util.funktion.Func<T, K>, arg1: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  ...
  mapping<T, U>(arg0: java.util.funktion.Func<T, U>, arg1: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  ...
  partitioningBy<T>(arg0: java.util.funktion.Predicate<T>): any /*java.util.stream.Collector*/;
  partitioningBy<T>(arg0: java.util.funktion.Predicate<T>, arg1: any /*java.util.stream.Collector*/): any /*java.util.stream.Collector*/;
  reducing<T, U>(arg0: U, arg1: java.util.funktion.Func<T, U>, arg2: java.util.funktion.BinaryOperator<U>): any /*java.util.stream.Collector*/;
  reducing<T>(arg0: java.util.funktion.BinaryOperator<T>): any /*java.util.stream.Collector*/;
  reducing<T>(arg0: T, arg1: java.util.funktion.BinaryOperator<T>): any /*java.util.stream.Collector*/;
  ...
  toCollection<C>(arg0: java.util.funktion.Supplier<C>): any /*java.util.stream.Collector*/;
  toConcurrentMap<K, T, U, M>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>, arg2: java.util.funktion.BinaryOperator<U>, arg3: java.util.funktion.Supplier<M>): any /*java.util.stream.Collector*/;
  toConcurrentMap<K, T, U>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>, arg2: java.util.funktion.BinaryOperator<U>): any /*java.util.stream.Collector*/;
  toConcurrentMap<K, T, U>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>): any /*java.util.stream.Collector*/;
  toList(): any /*java.util.stream.Collector*/;
  toMap<K, T, U, M>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>, arg2: java.util.funktion.BinaryOperator<U>, arg3: java.util.funktion.Supplier<M>): any /*java.util.stream.Collector*/;
  toMap<K, T, U>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>, arg2: java.util.funktion.BinaryOperator<U>): any /*java.util.stream.Collector*/;
  toMap<K, T, U>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>): any /*java.util.stream.Collector*/;
  toSet(): any /*java.util.stream.Collector*/;
  toUnmodifiableList(): any /*java.util.stream.Collector*/;
  toUnmodifiableMap<K, T, U>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>): any /*java.util.stream.Collector*/;
  toUnmodifiableMap<K, T, U>(arg0: java.util.funktion.Func<T, K>, arg1: java.util.funktion.Func<T, U>, arg2: java.util.funktion.BinaryOperator<U>): any /*java.util.stream.Collector*/;
