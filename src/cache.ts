...
import { sharedcache as cache } from "@runtime";
 ...
 */
export const get = (key: string, defaultSupplier?: any) => {
 ...
 */
export const put = (key: string, value: any): any|null => {
 ...
 */
export const remove = (key: string): any|null => {
