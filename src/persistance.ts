...
const pe: any = Java.type("org.openhab.core.persistence.extensions.PersistenceExtensions");

type ItemNameOrItem = string | org.openhab.core.items.Item;

// declare namespace org.openhab.core.persistence {
 ...
 */
export const persist = (item: ItemNameOrItem): void => {
    pe.persist(getItem(item));
}
 ...
 */
export const historicState = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): HistoricItem | null => {
    return pe.historicState(getItem(item), timestamp) as HistoricItem;
}
 ...
 */
export const changedSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): boolean => {
    return pe.changedSince(getItem(item), timestamp);
}
 ...
 *         available
 */
export const updatedSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): boolean => {
    return pe.updatedSince(getItem(item), timestamp);
}
 ...
 *         {@link QueryablePersistenceService}
 */
export const maximumSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): HistoricItem => {
    return pe.maximumSince(getItem(item), timestamp);
}
 ...
 */
export const minimumSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): HistoricItem => {
    return pe.minimumSince(getItem(item), timestamp);
}
 ...
 */
export const varianceSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): org.openhab.core.library.types.DecimalType | null => {
    return pe.varianceSince(getItem(item), timestamp);
}
 ...
 */
export const deviationSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): org.openhab.core.library.types.DecimalType | null => {
    return pe.deviationSince(getItem(item), timestamp);
}
 ...
 *         {@link QueryablePersistenceService}
 */
export const averageSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): org.openhab.core.library.types.DecimalType | null => {
    return pe.averageSince(getItem(item), timestamp);
}
 ...
 *         {@link QueryablePersistenceService}
 */
export const sumSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): org.openhab.core.library.types.DecimalType | null => {
    return pe.sumSince(getItem(item), timestamp);
}
 ...
 *         {@link QueryablePersistenceService}
 */
export const lastUpdate = (item: ItemNameOrItem): java.time.ZonedDateTime | null => {
    return pe.lastUpdate(getItem(item));
}
 ...
 */
export const deltaSince = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): org.openhab.core.library.types.DecimalType | null => {
    return pe.deltaSince(getItem(item), timestamp);
}
 ...
 */
export const evolutionRate = (item: ItemNameOrItem, timestamp: java.time.ZonedDateTime): org.openhab.core.library.types.DecimalType | null => {
    return pe.evolutionRate(getItem(item), timestamp);
}
 ...
 */
export const previousState = (item: ItemNameOrItem, skipEqual: boolean): HistoricItem | null => {
    return pe.previousState(getItem(item), skipEqual);
}